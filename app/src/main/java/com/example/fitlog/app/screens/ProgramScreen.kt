...
@Composable
fun TrainingDayCard(
    trainingDayDb: TrainingDayDB,
    programViewModel: ProgramViewModel,
    onClickEdit: (TrainingDayDB) -> Unit,
    onClickDelete: () -> Unit
){
    Card(
        modifier = Modifier
...
@Composable
fun DeleteDayDialog(day: TrainingDayDB, programViewModel: ProgramViewModel, state: MutableState<Boolean>) {
    AlertDialog(
        onDismissRequest = { state.value = false },
        confirmButton = {
            TextButton(onClick = {
...
@Composable
fun DeleteExerDialog(exercise: ExerciseDB, programViewModel: ProgramViewModel, state: MutableState<Boolean>) {
    AlertDialog(
        onDismissRequest = { state.value = false },
        confirmButton = {
            TextButton(onClick = {
